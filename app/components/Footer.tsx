                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-16 mb-20">
                    ...
                    <div className="lg:col-span-2 flex flex-col items-start justify-start">
                        ...
                        <div className="flex gap-4">
                            {/* Instagram */}
                            <a href="#" className="w-10 h-10 bg-[#F1F4F4]/50 border border-[#d8c3ac]/30 hover:border-[#ffaa00] text-[#825500] hover:text-[#ffaa00] flex items-center justify-center rounded-xl transition-all group shadow-sm">
